...
public class CbhsSettleDown(对下结算) implements Serializable{
...
private int cbhsSettleUpOid;// 必填|对上结算的ID
...
public int  getCbhsSettleUpOid(){ 

    return this.cbhsSettleUpOid;

}

public void setCbhsSettleUpOid(int cbhsSettleUpOid){
