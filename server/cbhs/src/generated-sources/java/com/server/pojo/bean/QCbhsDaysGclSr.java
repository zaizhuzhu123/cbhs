...
/**
 * QCbhsDaysGclSr is a Querydsl query type for CbhsDaysGclSr
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QCbhsDaysGclSr extends EntityPathBase<CbhsDaysGclSr> {

    private static final long serialVersionUID = 1462644252L;

    public static final QCbhsDaysGclSr cbhsDaysGclSr = new QCbhsDaysGclSr("cbhsDaysGclSr");
    ...
    public QCbhsDaysGclSr(String variable) {
        super(CbhsDaysGclSr.class, forVariable(variable));
    }

    public QCbhsDaysGclSr(Path<? extends CbhsDaysGclSr> path) {
        super(path.getType(), path.getMetadata());
    }

    public QCbhsDaysGclSr(PathMetadata metadata) {
        super(CbhsDaysGclSr.class, metadata);
    }
