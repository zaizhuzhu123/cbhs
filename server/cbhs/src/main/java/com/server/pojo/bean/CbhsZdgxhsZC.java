...
@DynamicInsert
@Entity
@Table(name = "CbhsZdgxhsZC")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@ApiModel(value="重点工序核算-主材对象",description="重点工序核算-主材对象")
public class CbhsZdgxhsZC implements Serializable {
	...
	@Column(name = "clKemuOid", nullable = true, unique = false,columnDefinition="Integer default 0")
	@ApiModelProperty(value = "材料科目ID",required=false)
	private Integer clKemuOid= 0;// 材料科目ID
	@Column(name = "clKemuName", length = 50, nullable = true, unique = false,columnDefinition="varchar(50) default ''")
	...
	public Integer getClKemuOid() { 

    	return this.clKemuOid;

	}

	public void setClKemuOid(Integer clKemuOid) {
