...
@ApiModel(value="成本汇总对象",description="成本汇总对象")
public class CbhsCb implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@ApiModelProperty(value = "总成本主键ID",required=false)
	private Integer oid= 0;// 总成本主键ID
	...
	@ApiModelProperty(value = "1间接成本 2管理费用 3零星用工 4机械成本 5自营其他费用 6自营材料成本 7分包临建项目 8分包工程量 9资源统计 10分包价格",required=false)
	private Integer type= 0;// 1间接成本 2管理费用 3零星用工 4机械成本 5自营其他费用 6自营材料成本 7分包临建项目 8分包工程量 9资源统计 10分包价格
