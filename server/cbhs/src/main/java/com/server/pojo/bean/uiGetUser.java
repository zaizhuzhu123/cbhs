...
public class uiGetUser implements Serializable {
	...
	@Column(name = "menuids", length = 2000, nullable = true, unique = false,columnDefinition="varchar(2000) default ''")
	...
	@ApiModelProperty(value = "管理员账号 true 管理员 ",required=false)
	...
	@Column(name = "avatarOid", nullable = true, unique = false,columnDefinition="Integer default 0")
	@ApiModelProperty(value = "头像对应的资源ID",required=false)
	private Integer avatarOid= 0;// 头像对应的资源ID
	@Column(name = "avatar", length = 500, nullable = true, unique = false,columnDefinition="varchar(500) default ''")
