...
@DynamicInsert
@Entity
@Table(name = "CbhsDaysZyJxCb")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@ApiModel(value="机械费用每日成本对象",description="机械费用每日成本对象")
public class CbhsDaysZyJxCb implements Serializable {
	...
	@ApiModelProperty(value = "必填|设备编号",required=false)
	private Integer machineryOid= 0;// 必填|设备编号
	...
	@ApiModelProperty(value = "必填|完成方量 单位 方",required=false)
	private BigDecimal completeCount= new BigDecimal(0);// 必填|完成方量 单位 方
	@Column(name = "workTimer",precision = 19, scale = 4, columnDefinition="decimal(19,4) default 0", nullable = true, unique = false)
	@ApiModelProperty(value = "必填|工作时长 单位 时",required=false)
	private BigDecimal workTimer= new BigDecimal(0);// 必填|工作时长 单位 时
	@Column(name = "ryOid", nullable = true, unique = false,columnDefinition="Integer default 0")
	@ApiModelProperty(value = "选填|燃油ID 对应到材料表",required=false)
	private Integer ryOid= 0;// 选填|燃油ID 对应到材料表
	...
	@ApiModelProperty(value = "选填|燃油名称",required=false)
	...
	@ApiModelProperty(value = "选填|燃油单位",required=false)
	...
	@ApiModelProperty(value = "选填|燃油使用量 单位L",required=false)
	private BigDecimal ryUseCount= new BigDecimal(0);// 选填|燃油使用量 单位L
	@Column(name = "ryPrice",precision = 19, scale = 4, columnDefinition="decimal(19,4) default 0", nullable = true, unique = false)
	@ApiModelProperty(value = "选填|燃油金额",required=false)
	private BigDecimal ryPrice= new BigDecimal(0);// 选填|燃油金额
	...
	@ApiModelProperty(value = "必填|机械成本金额（不包含燃油）",required=false)
	private BigDecimal total= new BigDecimal(0);// 必填|机械成本金额（不包含燃油）
	...
	public BigDecimal getWorkTimer() { 

    	return this.workTimer;

	}

	public void setWorkTimer(BigDecimal workTimer) {
 
        this.workTimer = workTimer;

	}

	public Integer getRyOid() { 

    	return this.ryOid;

	}

	public void setRyOid(Integer ryOid) {
