...
@ApiModel(value="分包商统计对象",description="分包商统计对象")
public class CbhsZytj implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@ApiModelProperty(value = "主键(资源统计)(创建不填|修改必填)",required=false)
	private Integer oid= 0;// 主键(资源统计)(创建不填|修改必填)
	...
	@ApiModelProperty(value = "必填|对应分包工程量ID 大项",required=false)
	private Integer globalGclYsOid= 0;// 必填|对应分包工程量ID 大项
	@Column(name = "globalGclYsName", length = 200, nullable = true, unique = false,columnDefinition="varchar(200) default ''")
	@ApiModelProperty(value = "必填|对应分包工程量 名称",required=false)
	...
	@Column(name = "jxCount", nullable = true, unique = false,columnDefinition="Integer default 0")
	@ApiModelProperty(value = "必填|机械数量",required=false)
	private Integer jxCount= 0;// 必填|机械数量
