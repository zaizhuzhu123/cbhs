...
@DynamicInsert
@Entity
@Table(name = "CbhsMonthFbLjxmCbYs")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@ApiModel(value="分包临建项目月预算对象",description="分包临建项目月预算对象")
public class CbhsMonthFbLjxmCbYs implements Serializable {
	...
	@Column(name = "no", length = 50, nullable = true, unique = false,columnDefinition="varchar(50) default ''")
	@ApiModelProperty(value = "必填|序号",required=false)
