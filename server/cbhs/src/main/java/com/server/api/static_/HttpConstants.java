...
public class HttpConstants {
    ...
    urlInfo114.setUrl("/cbhs/daysCb/fbLjxmCbAddCount");
    urlInfo114.setOpCode("0");
    urlInfo114.setWorkClass("");
    urlInfo114.setMsgReaquest("com.server.pojo.url.daysCb.RequestFbLjxmCbAddCount");
    ...
    urlInfo114.setRestClass("fbLjxmCbAddCount");
    ...
    urlInfo115.setMsgCode(50905);
    urlInfo115.setUrl("/cbhs/daysCb/fbLjxmCbAddJg");
    urlInfo115.setOpCode("0");
    urlInfo115.setWorkClass("");
    urlInfo115.setMsgReaquest("com.server.pojo.url.daysCb.RequestFbLjxmCbAddJg");
    urlInfo115.setReaquestDepict("数量统计ID,总金额,单价,提交方式(0默认提交 1审核提交)");
    urlInfo115.setMsgResponse("com.server.pojo.bean.CbhsDaysFbLjxmCb");
    urlInfo115.setResponseDepict("分包临建项目");
    urlInfo115.setTransation(true);
    urlInfo115.setRestClass("fbLjxmCbAddJg");
    ...
    urlInfo116.setMsgCode(50906);
    urlInfo116.setUrl("/cbhs/daysCb/fbLjxmCbUpdateJg");
    urlInfo116.setOpCode("0");
    urlInfo116.setWorkClass("");
    urlInfo116.setMsgReaquest("com.server.pojo.url.daysCb.RequestFbLjxmCbUpdateJg");
    urlInfo116.setReaquestDepict("数量统计ID,总金额,单价");
    urlInfo116.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo116.setResponseDepict("分包临建项目");
    urlInfo116.setTransation(true);
    urlInfo116.setRestClass("fbLjxmCbUpdateJg");
    ...
    urlInfo117.setMsgCode(51001);
    urlInfo117.setUrl("/cbhs/daysCb/fbJgUpdate");
    urlInfo117.setOpCode("0");
    urlInfo117.setWorkClass("");
    urlInfo117.setMsgReaquest("com.server.pojo.url.daysCb.RequestFbJgUpdate");
    urlInfo117.setReaquestDepict("分包工程ID,分包价格");
    urlInfo117.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo117.setResponseDepict("响应状态码");
    urlInfo117.setTransation(true);
    urlInfo117.setRestClass("fbJgUpdate");
    ...
    urlInfo118.setMsgCode(51002);
    urlInfo118.setUrl("/cbhs/daysCb/fbJgAdd");
    urlInfo118.setOpCode("0");
    urlInfo118.setWorkClass("");
    urlInfo118.setMsgReaquest("com.server.pojo.url.daysCb.RequestFbJgAdd");
    urlInfo118.setReaquestDepict("分包工程ID,分包总金额,分包单价,提交方式(0默认提交 1审核提交)");
    urlInfo118.setMsgResponse("com.server.pojo.bean.CbhsDaysFbGclTj");
    urlInfo118.setResponseDepict("响应状态码");
    urlInfo118.setTransation(true);
    urlInfo118.setRestClass("fbJgAdd");
    ...
    urlInfo119.setMsgCode(60101);
    urlInfo119.setUrl("/cbhs/daysSr/gcsrFetch");
    urlInfo119.setOpCode("0");
    urlInfo119.setWorkClass("");
    urlInfo119.setMsgReaquest("com.server.pojo.url.daysSr.RequestGcsrFetch");
    urlInfo119.setReaquestDepict("主键,部门ID,工程项目ID,工程量ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo119.setMsgResponse("com.server.pojo.url.daysSr.ResponseGcsrFetch");
    urlInfo119.setResponseDepict("工程收入集合,总条数");
    urlInfo119.setTransation(true);
    urlInfo119.setRestClass("gcsrFetch");
    ...
    urlInfo120.setMsgCode(60102);
    urlInfo120.setUrl("/cbhs/daysSr/gcsrUpdate");
    urlInfo120.setOpCode("0");
    urlInfo120.setWorkClass("");
    urlInfo120.setMsgReaquest("com.server.pojo.bean.CbhsDaysGclSr");
    urlInfo120.setReaquestDepict("工程收入");
    urlInfo120.setMsgResponse("com.server.pojo.bean.CbhsDaysGclSr");
    urlInfo120.setResponseDepict("工程收入");
    urlInfo120.setTransation(true);
    urlInfo120.setRestClass("gcsrUpdate");
    ...
    urlInfo121.setMsgCode(60103);
    urlInfo121.setUrl("/cbhs/daysSr/gcsrDel");
    urlInfo121.setOpCode("0");
    urlInfo121.setWorkClass("");
    urlInfo121.setMsgReaquest("com.server.pojo.url.daysSr.RequestGcsrDel");
    urlInfo121.setReaquestDepict("工程收入主键集合");
    urlInfo121.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo121.setResponseDepict("响应状态码");
    urlInfo121.setTransation(false);
    urlInfo121.setRestClass("gcsrDel");
    ...
    urlInfo122.setMsgCode(60104);
    urlInfo122.setUrl("/cbhs/daysSr/gcsrAdd");
    urlInfo122.setOpCode("0");
    urlInfo122.setWorkClass("");
    urlInfo122.setMsgReaquest("com.server.pojo.url.daysSr.RequestGcsrAdd");
    urlInfo122.setReaquestDepict("工程收入");
    urlInfo122.setMsgResponse("com.server.pojo.url.daysSr.ResponseGcsrAdd");
    urlInfo122.setResponseDepict("工程收入");
    urlInfo122.setTransation(true);
    urlInfo122.setRestClass("gcsrAdd");
    ...
    urlInfo123.setMsgCode(60201);
    urlInfo123.setUrl("/cbhs/daysSr/newsrFetch");
    urlInfo123.setOpCode("0");
    urlInfo123.setWorkClass("");
    urlInfo123.setMsgReaquest("com.server.pojo.url.daysSr.RequestNewsrFetch");
    urlInfo123.setReaquestDepict("主键,部门ID,工程项目ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo123.setMsgResponse("com.server.pojo.url.daysSr.ResponseNewsrFetch");
    urlInfo123.setResponseDepict("新增收入集合,总条数");
    urlInfo123.setTransation(true);
    urlInfo123.setRestClass("newsrFetch");
    ...
    urlInfo124.setMsgCode(60202);
    urlInfo124.setUrl("/cbhs/daysSr/newsrUpdate");
    ...
    urlInfo124.setRestClass("newsrUpdate");
    ...
    urlInfo125.setMsgCode(60203);
    urlInfo125.setUrl("/cbhs/daysSr/newsrDel");
    urlInfo125.setOpCode("0");
    urlInfo125.setWorkClass("");
    urlInfo125.setMsgReaquest("com.server.pojo.url.daysSr.RequestNewsrDel");
    urlInfo125.setReaquestDepict("新增收入主键集合");
    urlInfo125.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo125.setResponseDepict("响应状态码");
    urlInfo125.setTransation(false);
    urlInfo125.setRestClass("newsrDel");
    ...
    urlInfo126.setMsgCode(60204);
    urlInfo126.setUrl("/cbhs/daysSr/newsrAddCount");
    urlInfo126.setOpCode("0");
    urlInfo126.setWorkClass("");
    urlInfo126.setMsgReaquest("com.server.pojo.bean.CbhsDaysQtSr");
    urlInfo126.setReaquestDepict("新增收入");
    urlInfo126.setMsgResponse("com.server.pojo.bean.CbhsDaysQtSr");
    urlInfo126.setResponseDepict("新增收入");
    urlInfo126.setTransation(true);
    urlInfo126.setRestClass("newsrAddCount");
    ...
    urlInfo127.setMsgCode(60205);
    urlInfo127.setUrl("/cbhs/daysSr/newsrAddPrice");
    urlInfo127.setOpCode("0");
    urlInfo127.setWorkClass("");
    urlInfo127.setMsgReaquest("com.server.pojo.url.daysSr.RequestNewsrAddPrice");
    urlInfo127.setReaquestDepict("数量收入ID,总金额,单价");
    urlInfo127.setMsgResponse("com.server.pojo.bean.CbhsDaysQtSr");
    urlInfo127.setResponseDepict("新增收入");
    urlInfo127.setTransation(true);
    urlInfo127.setRestClass("newsrAddPrice");
    ...
    urlInfo128.setMsgCode(30101);
    urlInfo128.setUrl("/cbhs/globalYs/globalGclYsFetch");
    urlInfo128.setOpCode("0");
    urlInfo128.setWorkClass("");
    urlInfo128.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalGclYsFetch");
    urlInfo128.setReaquestDepict("主键,编号,名称,页码,数量,开始编号,工程项目ID,类型(1:大项|2:有单价的项)");
    urlInfo128.setMsgResponse("com.server.pojo.url.globalYs.ResponseGlobalGclYsFetch");
    urlInfo128.setResponseDepict("工程量集合,总条数,总费用");
    urlInfo128.setTransation(true);
    urlInfo128.setRestClass("globalGclYsFetch");
    ...
    urlInfo129.setMsgCode(30102);
    urlInfo129.setUrl("/cbhs/globalYs/globalGclYsUpdate");
    ...
    urlInfo129.setRestClass("globalGclYsUpdate");
    ...
    urlInfo130.setMsgCode(30103);
    urlInfo130.setUrl("/cbhs/globalYs/globalGclYsDel");
    urlInfo130.setOpCode("0");
    urlInfo130.setWorkClass("");
    urlInfo130.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalGclYsDel");
    urlInfo130.setReaquestDepict("工程量主键集合");
    urlInfo130.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo130.setResponseDepict("标识");
    urlInfo130.setTransation(false);
    urlInfo130.setRestClass("globalGclYsDel");
    ...
    urlInfo131.setMsgCode(30104);
    urlInfo131.setUrl("/cbhs/globalYs/globalGclYsImport");
    urlInfo131.setOpCode("0");
    urlInfo131.setWorkClass("");
    urlInfo131.setMsgReaquest("com.server.pojo.bean.MultipartFile");
    urlInfo131.setReaquestDepict("上传的文件,所属的项目ID");
    urlInfo131.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo131.setResponseDepict("标识");
    urlInfo131.setTransation(true);
    urlInfo131.setRestClass("globalGclYsImport");
    ...
    urlInfo132.setMsgCode(30105);
    urlInfo132.setUrl("/cbhs/globalYs/globalGclYsAdd");
    urlInfo132.setOpCode("0");
    urlInfo132.setWorkClass("");
    urlInfo132.setMsgReaquest("com.server.pojo.bean.CbhsGclQdYs");
    urlInfo132.setReaquestDepict("工程量");
    urlInfo132.setMsgResponse("com.server.pojo.bean.CbhsGclQdYs");
    urlInfo132.setResponseDepict("工程量");
    urlInfo132.setTransation(true);
    urlInfo132.setRestClass("globalGclYsAdd");
    ...
    urlInfo133.setMsgCode(30201);
    urlInfo133.setUrl("/cbhs/globalYs/globalRcjzhlYsFetch");
    urlInfo133.setOpCode("0");
    urlInfo133.setWorkClass("");
    urlInfo133.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalRcjzhlYsFetch");
    urlInfo133.setReaquestDepict("ID,编号,名称,页码,数量,开始编号,工程项目ID");
    urlInfo133.setMsgResponse("com.server.pojo.url.globalYs.ResponseGlobalRcjzhlYsFetch");
    urlInfo133.setResponseDepict("总耗量预算集合,总条数,总费用");
    urlInfo133.setTransation(true);
    urlInfo133.setRestClass("globalRcjzhlYsFetch");
    ...
    urlInfo134.setMsgCode(30202);
    urlInfo134.setUrl("/cbhs/globalYs/globalRcjzhlYsUpdate");
    ...
    urlInfo134.setRestClass("globalRcjzhlYsUpdate");
    ...
    urlInfo135.setMsgCode(30203);
    urlInfo135.setUrl("/cbhs/globalYs/globalRcjzhlYsDel");
    urlInfo135.setOpCode("0");
    urlInfo135.setWorkClass("");
    urlInfo135.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalRcjzhlYsDel");
    urlInfo135.setReaquestDepict("总耗量预算主键集合");
    urlInfo135.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo135.setResponseDepict("响应状态码");
    urlInfo135.setTransation(false);
    urlInfo135.setRestClass("globalRcjzhlYsDel");
    ...
    urlInfo136.setMsgCode(30204);
    urlInfo136.setUrl("/cbhs/globalYs/globalRcjzhlYsImport");
    urlInfo136.setOpCode("0");
    urlInfo136.setWorkClass("");
    urlInfo136.setMsgReaquest("com.server.pojo.bean.MultipartFile");
    urlInfo136.setReaquestDepict("上传的文件");
    urlInfo136.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo136.setResponseDepict("响应状态码");
    urlInfo136.setTransation(true);
    urlInfo136.setRestClass("globalRcjzhlYsImport");
    ...
    urlInfo137.setMsgCode(30205);
    urlInfo137.setUrl("/cbhs/globalYs/globalRcjzhlYsAdd");
    urlInfo137.setOpCode("0");
    urlInfo137.setWorkClass("");
    urlInfo137.setMsgReaquest("com.server.pojo.bean.CbhsGlobalRcjzhlYs");
    urlInfo137.setReaquestDepict("总耗量预算");
    urlInfo137.setMsgResponse("com.server.pojo.bean.CbhsGlobalRcjzhlYs");
    urlInfo137.setResponseDepict("总耗量预算");
    urlInfo137.setTransation(true);
    urlInfo137.setRestClass("globalRcjzhlYsAdd");
    ...
    urlInfo138.setMsgCode(30301);
    urlInfo138.setUrl("/cbhs/globalYs/globalFyzYsFetch");
    urlInfo138.setOpCode("0");
    urlInfo138.setWorkClass("");
    urlInfo138.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalFyzYsFetch");
    urlInfo138.setReaquestDepict("ID,编号,名称,页码,数量,开始编号,工程项目ID");
    urlInfo138.setMsgResponse("com.server.pojo.url.globalYs.ResponseGlobalFyzYsFetch");
    urlInfo138.setResponseDepict("费用总预算集合,总条数,总费用");
    urlInfo138.setTransation(true);
    urlInfo138.setRestClass("globalFyzYsFetch");
    ...
    urlInfo139.setMsgCode(30302);
    urlInfo139.setUrl("/cbhs/globalYs/globalFyzYsUpdate");
    ...
    urlInfo139.setRestClass("globalFyzYsUpdate");
    ...
    urlInfo140.setMsgCode(30303);
    urlInfo140.setUrl("/cbhs/globalYs/globalFyzYsDel");
    urlInfo140.setOpCode("0");
    urlInfo140.setWorkClass("");
    urlInfo140.setMsgReaquest("com.server.pojo.url.globalYs.RequestGlobalFyzYsDel");
    urlInfo140.setReaquestDepict("费用总预算主键集合");
    ...
    urlInfo140.setRestClass("globalFyzYsDel");
    ...
    urlInfo141.setMsgCode(30304);
    urlInfo141.setUrl("/cbhs/globalYs/globalFyzYsImport");
    ...
    urlInfo141.setRestClass("globalFyzYsImport");
    ...
    urlInfo142.setMsgCode(30305);
    urlInfo142.setUrl("/cbhs/globalYs/globalFyzYsAdd");
    urlInfo142.setOpCode("0");
    urlInfo142.setWorkClass("");
    urlInfo142.setMsgReaquest("com.server.pojo.bean.CbhsGlobalFyzYs");
    urlInfo142.setReaquestDepict("费用总预算");
    urlInfo142.setMsgResponse("com.server.pojo.bean.CbhsGlobalFyzYs");
    urlInfo142.setResponseDepict("费用总预算");
    urlInfo142.setTransation(true);
    urlInfo142.setRestClass("globalFyzYsAdd");
    ...
    urlInfo143.setMsgCode(40101);
    urlInfo143.setUrl("/cbhs/monthMbYs/jjcbYsFetch");
    urlInfo143.setOpCode("0");
    urlInfo143.setWorkClass("");
    urlInfo143.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestJjcbYsFetch");
    urlInfo143.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo143.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseJjcbYsFetch");
    urlInfo143.setResponseDepict("间接成本预算集合,总条数");
    urlInfo143.setTransation(true);
    urlInfo143.setRestClass("jjcbYsFetch");
    ...
    urlInfo144.setMsgCode(40102);
    urlInfo144.setUrl("/cbhs/monthMbYs/jjcbYsUpdate");
    urlInfo144.setOpCode("0");
    urlInfo144.setWorkClass("");
    urlInfo144.setMsgReaquest("com.server.pojo.bean.CbhsMonthJjcbYs");
    urlInfo144.setReaquestDepict("间接成本");
    urlInfo144.setMsgResponse("com.server.pojo.bean.CbhsMonthJjcbYs");
    urlInfo144.setResponseDepict("间接成本预算");
    urlInfo144.setTransation(true);
    urlInfo144.setRestClass("jjcbYsUpdate");
    ...
    urlInfo145.setMsgCode(40103);
    urlInfo145.setUrl("/cbhs/monthMbYs/jjcbYsDel");
    urlInfo145.setOpCode("0");
    urlInfo145.setWorkClass("");
    urlInfo145.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestJjcbYsDel");
    urlInfo145.setReaquestDepict("间接成本主键集合");
    ...
    urlInfo145.setRestClass("jjcbYsDel");
    ...
    urlInfo146.setMsgCode(40104);
    urlInfo146.setUrl("/cbhs/monthMbYs/jjcbYsAdd");
    urlInfo146.setOpCode("0");
    urlInfo146.setWorkClass("");
    urlInfo146.setMsgReaquest("com.server.pojo.bean.CbhsMonthJjcbYs");
    urlInfo146.setReaquestDepict("间接成本");
    urlInfo146.setMsgResponse("com.server.pojo.bean.CbhsMonthJjcbYs");
    urlInfo146.setResponseDepict("间接成本预算");
    urlInfo146.setTransation(true);
    urlInfo146.setRestClass("jjcbYsAdd");
    ...
    urlInfo147.setMsgCode(40201);
    urlInfo147.setUrl("/cbhs/monthMbYs/glfyYsFetch");
    urlInfo147.setOpCode("0");
    urlInfo147.setWorkClass("");
    urlInfo147.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestGlfyYsFetch");
    urlInfo147.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo147.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseGlfyYsFetch");
    urlInfo147.setResponseDepict("管理费用集合,总条数");
    urlInfo147.setTransation(true);
    urlInfo147.setRestClass("glfyYsFetch");
    ...
    urlInfo148.setMsgCode(40202);
    urlInfo148.setUrl("/cbhs/monthMbYs/glfyYsUpdate");
    urlInfo148.setOpCode("0");
    urlInfo148.setWorkClass("");
    urlInfo148.setMsgReaquest("com.server.pojo.bean.CbhsMonthGlfyYs");
    urlInfo148.setReaquestDepict("管理经费");
    urlInfo148.setMsgResponse("com.server.pojo.bean.CbhsMonthGlfyYs");
    urlInfo148.setResponseDepict("管理费用");
    urlInfo148.setTransation(true);
    urlInfo148.setRestClass("glfyYsUpdate");
    ...
    urlInfo149.setMsgCode(40203);
    urlInfo149.setUrl("/cbhs/monthMbYs/glfyYsDel");
    urlInfo149.setOpCode("0");
    urlInfo149.setWorkClass("");
    urlInfo149.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestGlfyYsDel");
    urlInfo149.setReaquestDepict("管理经费主键集合");
    urlInfo149.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo149.setResponseDepict("响应状态码");
    urlInfo149.setTransation(false);
    urlInfo149.setRestClass("glfyYsDel");
    ...
    urlInfo150.setMsgCode(40204);
    urlInfo150.setUrl("/cbhs/monthMbYs/glfyYsAdd");
    urlInfo150.setOpCode("0");
    urlInfo150.setWorkClass("");
    urlInfo150.setMsgReaquest("com.server.pojo.bean.CbhsMonthGlfyYs");
    urlInfo150.setReaquestDepict("管理经费");
    urlInfo150.setMsgResponse("com.server.pojo.bean.CbhsMonthGlfyYs");
    urlInfo150.setResponseDepict("管理费用");
    urlInfo150.setTransation(true);
    urlInfo150.setRestClass("glfyYsAdd");
    ...
    urlInfo151.setMsgCode(40301);
    urlInfo151.setUrl("/cbhs/monthMbYs/zyCailiaoCbYsFetch");
    urlInfo151.setOpCode("0");
    urlInfo151.setWorkClass("");
    urlInfo151.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyCailiaoCbYsFetch");
    urlInfo151.setReaquestDepict("主键,部门ID,工程量ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo151.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyCailiaoCbYsFetch");
    urlInfo151.setResponseDepict("自营材料成本集合,总条数");
    urlInfo151.setTransation(true);
    urlInfo151.setRestClass("zyCailiaoCbYsFetch");
    ...
    urlInfo152.setMsgCode(40302);
    urlInfo152.setUrl("/cbhs/monthMbYs/zyCailiaoCbYsUpdate");
    urlInfo152.setOpCode("0");
    urlInfo152.setWorkClass("");
    urlInfo152.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyCailiaoCbYs");
    urlInfo152.setReaquestDepict("自营材料成本");
    urlInfo152.setMsgResponse("com.server.pojo.bean.CbhsMonthZyCailiaoCbYs");
    urlInfo152.setResponseDepict("自营材料成本");
    urlInfo152.setTransation(true);
    urlInfo152.setRestClass("zyCailiaoCbYsUpdate");
    ...
    urlInfo153.setMsgCode(40303);
    urlInfo153.setUrl("/cbhs/monthMbYs/zyCailiaoCbYsDel");
    urlInfo153.setOpCode("0");
    urlInfo153.setWorkClass("");
    urlInfo153.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyCailiaoCbYsDel");
    urlInfo153.setReaquestDepict("自营材料成本主键集合");
    urlInfo153.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo153.setResponseDepict("响应状态码");
    urlInfo153.setTransation(false);
    urlInfo153.setRestClass("zyCailiaoCbYsDel");
    ...
    urlInfo154.setMsgCode(40304);
    urlInfo154.setUrl("/cbhs/monthMbYs/zyCailiaoCbYsAdd");
    urlInfo154.setOpCode("0");
    urlInfo154.setWorkClass("");
    urlInfo154.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyCailiaoCbYsAdd");
    urlInfo154.setReaquestDepict("自营材料成本集合 可批量添加");
    urlInfo154.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyCailiaoCbYsAdd");
    urlInfo154.setResponseDepict("自营材料成本集合");
    urlInfo154.setTransation(true);
    urlInfo154.setRestClass("zyCailiaoCbYsAdd");
    ...
    urlInfo155.setMsgCode(40305);
    urlInfo155.setUrl("/cbhs/monthMbYs/zyCailiaoCbYsCailiaoFetch");
    urlInfo155.setOpCode("0");
    urlInfo155.setWorkClass("");
    urlInfo155.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyCailiaoCbYsCailiaoFetch");
    urlInfo155.setReaquestDepict("部门ID,工程量ID,工程项目ID,月份时间戳,页码,数量,开始ID,是否是燃油 1是 2不是");
    urlInfo155.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyCailiaoCbYsCailiaoFetch");
    urlInfo155.setResponseDepict("材料集合,总条数");
    urlInfo155.setTransation(true);
    urlInfo155.setRestClass("zyCailiaoCbYsCailiaoFetch");
    ...
    urlInfo156.setMsgCode(40401);
    urlInfo156.setUrl("/cbhs/monthMbYs/zyLxygCbYsFetch");
    urlInfo156.setOpCode("0");
    urlInfo156.setWorkClass("");
    urlInfo156.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyLxygCbYsFetch");
    urlInfo156.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo156.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyLxygCbYsFetch");
    urlInfo156.setResponseDepict("自营零星用工成本集合,总条数");
    urlInfo156.setTransation(true);
    urlInfo156.setRestClass("zyLxygCbYsFetch");
    ...
    urlInfo157.setMsgCode(40402);
    urlInfo157.setUrl("/cbhs/monthMbYs/zyLxygCbYsUpdate");
    urlInfo157.setOpCode("0");
    urlInfo157.setWorkClass("");
    urlInfo157.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyLxygCbYs");
    urlInfo157.setReaquestDepict("自营零星用工");
    urlInfo157.setMsgResponse("com.server.pojo.bean.CbhsMonthZyLxygCbYs");
    urlInfo157.setResponseDepict("自营零星用工成本");
    urlInfo157.setTransation(true);
    urlInfo157.setRestClass("zyLxygCbYsUpdate");
    ...
    urlInfo158.setMsgCode(40403);
    urlInfo158.setUrl("/cbhs/monthMbYs/zyLxygCbYsDel");
    urlInfo158.setOpCode("0");
    urlInfo158.setWorkClass("");
    urlInfo158.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyLxygCbYsDel");
    urlInfo158.setReaquestDepict("自营零星用工主键集合");
    ...
    urlInfo158.setRestClass("zyLxygCbYsDel");
    ...
    urlInfo159.setMsgCode(40404);
    urlInfo159.setUrl("/cbhs/monthMbYs/zyLxygCbYsAdd");
    urlInfo159.setOpCode("0");
    urlInfo159.setWorkClass("");
    urlInfo159.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyLxygCbYs");
    urlInfo159.setReaquestDepict("自营零星用工");
    urlInfo159.setMsgResponse("com.server.pojo.bean.CbhsMonthZyLxygCbYs");
    urlInfo159.setResponseDepict("自营零星用工成本集合");
    urlInfo159.setTransation(true);
    urlInfo159.setRestClass("zyLxygCbYsAdd");
    ...
    urlInfo160.setMsgCode(40501);
    urlInfo160.setUrl("/cbhs/monthMbYs/zyJxCbYsFetch");
    urlInfo160.setOpCode("0");
    urlInfo160.setWorkClass("");
    urlInfo160.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyJxCbYsFetch");
    urlInfo160.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo160.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyJxCbYsFetch");
    urlInfo160.setResponseDepict("自营机械成本集合,总条数");
    urlInfo160.setTransation(true);
    urlInfo160.setRestClass("zyJxCbYsFetch");
    ...
    urlInfo161.setMsgCode(40502);
    urlInfo161.setUrl("/cbhs/monthMbYs/zyJxCbYsUpdate");
    urlInfo161.setOpCode("0");
    urlInfo161.setWorkClass("");
    urlInfo161.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyJxCbYs");
    urlInfo161.setReaquestDepict("自营机械成本");
    urlInfo161.setMsgResponse("com.server.pojo.bean.CbhsMonthZyJxCbYs");
    urlInfo161.setResponseDepict("自营机械成本成本");
    urlInfo161.setTransation(true);
    urlInfo161.setRestClass("zyJxCbYsUpdate");
    ...
    urlInfo162.setMsgCode(40503);
    urlInfo162.setUrl("/cbhs/monthMbYs/zyJxCbYsDel");
    urlInfo162.setOpCode("0");
    urlInfo162.setWorkClass("");
    urlInfo162.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyJxCbYsDel");
    urlInfo162.setReaquestDepict("自营机械成本主键集合");
    urlInfo162.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo162.setResponseDepict("响应状态码");
    urlInfo162.setTransation(false);
    urlInfo162.setRestClass("zyJxCbYsDel");
    ...
    urlInfo163.setMsgCode(40504);
    urlInfo163.setUrl("/cbhs/monthMbYs/zyJxCbYsAdd");
    urlInfo163.setOpCode("0");
    urlInfo163.setWorkClass("");
    urlInfo163.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyJxCbYs");
    urlInfo163.setReaquestDepict("自营机械成本");
    urlInfo163.setMsgResponse("com.server.pojo.bean.CbhsMonthZyJxCbYs");
    urlInfo163.setResponseDepict("自营机械成本集合");
    urlInfo163.setTransation(true);
    urlInfo163.setRestClass("zyJxCbYsAdd");
    ...
    urlInfo164.setMsgCode(40601);
    urlInfo164.setUrl("/cbhs/monthMbYs/zyQtfyYsFetch");
    urlInfo164.setOpCode("0");
    urlInfo164.setWorkClass("");
    urlInfo164.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyQtfyYsFetch");
    urlInfo164.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo164.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseZyQtfyYsFetch");
    urlInfo164.setResponseDepict("自营其他费用集合,总条数");
    urlInfo164.setTransation(true);
    urlInfo164.setRestClass("zyQtfyYsFetch");
    ...
    urlInfo165.setMsgCode(40602);
    urlInfo165.setUrl("/cbhs/monthMbYs/zyQtfyYsUpdate");
    urlInfo165.setOpCode("0");
    urlInfo165.setWorkClass("");
    urlInfo165.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyQtfyYs");
    urlInfo165.setReaquestDepict("自营其他费用");
    urlInfo165.setMsgResponse("com.server.pojo.bean.CbhsMonthZyQtfyYs");
    urlInfo165.setResponseDepict("自营其他费用成本");
    urlInfo165.setTransation(true);
    urlInfo165.setRestClass("zyQtfyYsUpdate");
    ...
    urlInfo166.setMsgCode(40603);
    urlInfo166.setUrl("/cbhs/monthMbYs/zyQtfyYsDel");
    urlInfo166.setOpCode("0");
    urlInfo166.setWorkClass("");
    urlInfo166.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestZyQtfyYsDel");
    urlInfo166.setReaquestDepict("自营其他费用主键集合");
    urlInfo166.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo166.setResponseDepict("响应状态码");
    urlInfo166.setTransation(false);
    urlInfo166.setRestClass("zyQtfyYsDel");
    ...
    urlInfo167.setMsgCode(40604);
    urlInfo167.setUrl("/cbhs/monthMbYs/zyQtfyYsAdd");
    urlInfo167.setOpCode("0");
    urlInfo167.setWorkClass("");
    urlInfo167.setMsgReaquest("com.server.pojo.bean.CbhsMonthZyQtfyYs");
    urlInfo167.setReaquestDepict("自营其他费用");
    urlInfo167.setMsgResponse("com.server.pojo.bean.CbhsMonthZyQtfyYs");
    urlInfo167.setResponseDepict("自营其他费用集合");
    urlInfo167.setTransation(true);
    urlInfo167.setRestClass("zyQtfyYsAdd");
    ...
    urlInfo168.setMsgCode(40701);
    urlInfo168.setUrl("/cbhs/monthMbYs/fbLjxmCbYsFetch");
    urlInfo168.setOpCode("0");
    urlInfo168.setWorkClass("");
    urlInfo168.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbLjxmCbYsFetch");
    urlInfo168.setReaquestDepict("主键,部门ID,工程项目ID,月份时间戳,页码,数量,开始ID");
    urlInfo168.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbLjxmCbYsFetch");
    urlInfo168.setResponseDepict("分包临建项目集合,总条数");
    urlInfo168.setTransation(true);
    urlInfo168.setRestClass("fbLjxmCbYsFetch");
    ...
    urlInfo169.setMsgCode(40702);
    urlInfo169.setUrl("/cbhs/monthMbYs/fbLjxmCbYsUpdate");
    urlInfo169.setOpCode("0");
    urlInfo169.setWorkClass("");
    urlInfo169.setMsgReaquest("com.server.pojo.bean.CbhsMonthFbLjxmCbYs");
    urlInfo169.setReaquestDepict("分包临建项目");
    urlInfo169.setMsgResponse("com.server.pojo.bean.CbhsMonthFbLjxmCbYs");
    urlInfo169.setResponseDepict("分包临建项目");
    urlInfo169.setTransation(true);
    urlInfo169.setRestClass("fbLjxmCbYsUpdate");
    ...
    urlInfo170.setMsgCode(40703);
    urlInfo170.setUrl("/cbhs/monthMbYs/fbLjxmCbYsDel");
    urlInfo170.setOpCode("0");
    urlInfo170.setWorkClass("");
    urlInfo170.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbLjxmCbYsDel");
    urlInfo170.setReaquestDepict("分包临建项目主键集合");
    urlInfo170.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo170.setResponseDepict("响应状态码");
    urlInfo170.setTransation(false);
    urlInfo170.setRestClass("fbLjxmCbYsDel");
    ...
    urlInfo171.setMsgCode(40704);
    urlInfo171.setUrl("/cbhs/monthMbYs/fbLjxmCbYsAdd");
    urlInfo171.setOpCode("0");
    urlInfo171.setWorkClass("");
    urlInfo171.setMsgReaquest("com.server.pojo.bean.CbhsMonthFbLjxmCbYs");
    urlInfo171.setReaquestDepict("分包临建项目");
    urlInfo171.setMsgResponse("com.server.pojo.bean.CbhsMonthFbLjxmCbYs");
    urlInfo171.setResponseDepict("分包临建项目");
    urlInfo171.setTransation(true);
    urlInfo171.setRestClass("fbLjxmCbYsAdd");
    ...
    urlInfo172.setMsgCode(40801);
    urlInfo172.setUrl("/cbhs/monthMbYs/fbGcCbYsFetch");
    urlInfo172.setOpCode("0");
    urlInfo172.setWorkClass("");
    urlInfo172.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbGcCbYsFetch");
    urlInfo172.setReaquestDepict("主键,部门ID,工程量ID,工程项目ID,月份时间戳,页码,数量,开始ID,类型(1:大项|2:有单价的项),分包商ID,合同ID");
    urlInfo172.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbGcCbYsFetch");
    urlInfo172.setResponseDepict("分包工程集合,总条数,总费用");
    urlInfo172.setTransation(true);
    urlInfo172.setRestClass("fbGcCbYsFetch");
    ...
    urlInfo173.setMsgCode(40802);
    urlInfo173.setUrl("/cbhs/monthMbYs/fbGcCbYsUpdate");
    urlInfo173.setOpCode("0");
    urlInfo173.setWorkClass("");
    urlInfo173.setMsgReaquest("com.server.pojo.bean.CbhsMonthFbGcCbYs");
    urlInfo173.setReaquestDepict("分包工程");
    urlInfo173.setMsgResponse("com.server.pojo.bean.CbhsMonthFbGcCbYs");
    urlInfo173.setResponseDepict("分包工程");
    urlInfo173.setTransation(true);
    urlInfo173.setRestClass("fbGcCbYsUpdate");
    ...
    urlInfo174.setMsgCode(40803);
    urlInfo174.setUrl("/cbhs/monthMbYs/fbGcCbYsDel");
    urlInfo174.setOpCode("0");
    urlInfo174.setWorkClass("");
    urlInfo174.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbGcCbYsDel");
    urlInfo174.setReaquestDepict("分包工程主键集合");
    urlInfo174.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo174.setResponseDepict("响应状态码");
    urlInfo174.setTransation(false);
    urlInfo174.setRestClass("fbGcCbYsDel");
    ...
    urlInfo175.setMsgCode(40804);
    urlInfo175.setUrl("/cbhs/monthMbYs/fbGcCbYsAdd");
    urlInfo175.setOpCode("0");
    urlInfo175.setWorkClass("");
    urlInfo175.setMsgReaquest("com.server.pojo.bean.CbhsMonthFbGcCbYs");
    urlInfo175.setReaquestDepict("分包工程");
    urlInfo175.setMsgResponse("com.server.pojo.bean.CbhsMonthFbGcCbYs");
    urlInfo175.setResponseDepict("分包工程");
    urlInfo175.setTransation(true);
    urlInfo175.setRestClass("fbGcCbYsAdd");
    ...
    urlInfo176.setMsgCode(40805);
    urlInfo176.setUrl("/cbhs/monthMbYs/fbGcGlobalXmFetch");
    urlInfo176.setOpCode("0");
    urlInfo176.setWorkClass("");
    urlInfo176.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbGcGlobalXmFetch");
    urlInfo176.setReaquestDepict("工程项目ID,部门ID,月份时间戳,页码,数量,开始ID");
    urlInfo176.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbGcGlobalXmFetch");
    urlInfo176.setResponseDepict("分包工程大项集合,总条数");
    urlInfo176.setTransation(true);
    urlInfo176.setRestClass("fbGcGlobalXmFetch");
    ...
    urlInfo177.setMsgCode(40806);
    urlInfo177.setUrl("/cbhs/monthMbYs/fbGcFbCompanyFetch");
    urlInfo177.setOpCode("0");
    urlInfo177.setWorkClass("");
    urlInfo177.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbGcFbCompanyFetch");
    urlInfo177.setReaquestDepict("工程项目ID,部门ID,月份时间戳,页码,数量,开始ID");
    urlInfo177.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbGcFbCompanyFetch");
    urlInfo177.setResponseDepict("分包工程大项集合,总条数");
    urlInfo177.setTransation(true);
    urlInfo177.setRestClass("fbGcFbCompanyFetch");
    ...
    urlInfo178.setMsgCode(40901);
    urlInfo178.setUrl("/cbhs/monthMbYs/fbCailiaoCbYsFetch");
    urlInfo178.setOpCode("0");
    urlInfo178.setWorkClass("");
    urlInfo178.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbCailiaoCbYsFetch");
    urlInfo178.setReaquestDepict("主键,部门ID,分包工程量ID,工程项目ID,月份时间戳,页码,数量,开始ID,分包商ID");
    urlInfo178.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbCailiaoCbYsFetch");
    urlInfo178.setResponseDepict("分包材料成本集合,总条数");
    urlInfo178.setTransation(true);
    urlInfo178.setRestClass("fbCailiaoCbYsFetch");
    ...
    urlInfo179.setMsgCode(40902);
    urlInfo179.setUrl("/cbhs/monthMbYs/fbCailiaoCbYsUpdate");
    urlInfo179.setOpCode("0");
    urlInfo179.setWorkClass("");
    urlInfo179.setMsgReaquest("com.server.pojo.bean.CbhsMonthFbCailiaoCbYs");
    urlInfo179.setReaquestDepict("分包材料成本");
    urlInfo179.setMsgResponse("com.server.pojo.bean.CbhsMonthFbCailiaoCbYs");
    urlInfo179.setResponseDepict("分包材料成本");
    urlInfo179.setTransation(true);
    urlInfo179.setRestClass("fbCailiaoCbYsUpdate");
    ...
    urlInfo180.setMsgCode(40903);
    urlInfo180.setUrl("/cbhs/monthMbYs/fbCailiaoCbYsDel");
    urlInfo180.setOpCode("0");
    urlInfo180.setWorkClass("");
    urlInfo180.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbCailiaoCbYsDel");
    urlInfo180.setReaquestDepict("分包材料成本主键集合");
    urlInfo180.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo180.setResponseDepict("响应状态码");
    urlInfo180.setTransation(false);
    urlInfo180.setRestClass("fbCailiaoCbYsDel");
    ...
    urlInfo181.setMsgCode(40904);
    urlInfo181.setUrl("/cbhs/monthMbYs/fbCailiaoCbYsAdd");
    urlInfo181.setOpCode("0");
    urlInfo181.setWorkClass("");
    urlInfo181.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbCailiaoCbYsAdd");
    urlInfo181.setReaquestDepict("分包材料成本");
    urlInfo181.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbCailiaoCbYsAdd");
    urlInfo181.setResponseDepict("分包材料成本");
    urlInfo181.setTransation(true);
    urlInfo181.setRestClass("fbCailiaoCbYsAdd");
    ...
    urlInfo182.setMsgCode(40905);
    urlInfo182.setUrl("/cbhs/monthMbYs/fbCailiaoCbYsCailiaoFetch");
    urlInfo182.setOpCode("0");
    urlInfo182.setWorkClass("");
    urlInfo182.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestFbCailiaoCbYsCailiaoFetch");
    urlInfo182.setReaquestDepict("主键,部门ID,分包工程量ID,工程项目ID,月份时间戳,页码,数量,开始ID,是否是燃油 1是 2不是");
    urlInfo182.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseFbCailiaoCbYsCailiaoFetch");
    urlInfo182.setResponseDepict("分包材料成本");
    urlInfo182.setTransation(true);
    urlInfo182.setRestClass("fbCailiaoCbYsCailiaoFetch");
    ...
    urlInfo183.setMsgCode(41001);
    urlInfo183.setUrl("/cbhs/monthMbYs/mbYsFetch");
    urlInfo183.setOpCode("0");
    urlInfo183.setWorkClass("");
    urlInfo183.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestMbYsFetch");
    urlInfo183.setReaquestDepict("工程项目ID,部门编号 0为所有部门汇总,月份");
    urlInfo183.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseMbYsFetch");
    urlInfo183.setResponseDepict("间接成本总量,管理费用总量,直接成本总量");
    urlInfo183.setTransation(true);
    urlInfo183.setRestClass("mbYsFetch");
    ...
    urlInfo184.setMsgCode(41002);
    urlInfo184.setUrl("/cbhs/monthMbYs/mbYsTotalFetch");
    urlInfo184.setOpCode("0");
    urlInfo184.setWorkClass("");
    urlInfo184.setMsgReaquest("com.server.pojo.url.monthMbYs.RequestMbYsTotalFetch");
    urlInfo184.setReaquestDepict("工程项目ID,部门编号 0为所有部门汇总,月份");
    urlInfo184.setMsgResponse("com.server.pojo.url.monthMbYs.ResponseMbYsTotalFetch");
    urlInfo184.setResponseDepict("结果,总条数,月份所有部门总预算");
    urlInfo184.setTransation(true);
    urlInfo184.setRestClass("mbYsTotalFetch");
    ...
    urlInfo185.setMsgCode(100101);
    urlInfo185.setUrl("/cbhs/tjbb/cbsrbb");
    urlInfo185.setOpCode("0");
    urlInfo185.setWorkClass("");
    urlInfo185.setMsgReaquest("com.server.pojo.url.tjbb.RequestCbsrbb");
    urlInfo185.setReaquestDepict("工程项目ID,开始日期,结束日期");
    urlInfo185.setMsgResponse("com.server.pojo.url.tjbb.ResponseCbsrbb");
    urlInfo185.setResponseDepict("成本集合,收入集合");
    urlInfo185.setTransation(true);
    urlInfo185.setRestClass("cbsrbb");
    ...
    urlInfo186.setMsgCode(100102);
    urlInfo186.setUrl("/cbhs/tjbb/zybb");
    urlInfo186.setOpCode("0");
    urlInfo186.setWorkClass("");
    urlInfo186.setMsgReaquest("com.server.pojo.url.tjbb.RequestZybb");
    urlInfo186.setReaquestDepict("工程项目ID,分包商ID,开始日期,结束日期");
    urlInfo186.setMsgResponse("com.server.pojo.url.tjbb.ResponseZybb");
    urlInfo186.setResponseDepict("成本集合,收入集合");
    urlInfo186.setTransation(true);
    urlInfo186.setRestClass("zybb");
    ...
    urlInfo187.setMsgCode(100103);
    urlInfo187.setUrl("/cbhs/tjbb/daysDetails");
    urlInfo187.setOpCode("0");
    urlInfo187.setWorkClass("");
    urlInfo187.setMsgReaquest("com.server.pojo.url.tjbb.RequestDaysDetails");
    urlInfo187.setReaquestDepict("部门ID,工程项目ID,日期时间戳");
    urlInfo187.setMsgResponse("com.server.pojo.bean.uiDaysCbDetailTj");
    urlInfo187.setResponseDepict("每日数据详情");
    urlInfo187.setTransation(true);
    urlInfo187.setRestClass("daysDetails");
    ...
    urlInfo188.setMsgCode(100104);
    urlInfo188.setUrl("/cbhs/tjbb/grandTotal");
    urlInfo188.setOpCode("0");
    urlInfo188.setWorkClass("");
    urlInfo188.setMsgReaquest("com.server.pojo.url.tjbb.RequestGrandTotal");
    urlInfo188.setReaquestDepict("工程项目ID,开始时间,结束时间");
    urlInfo188.setMsgResponse("com.server.pojo.bean.uiGrandTotalTj");
    urlInfo188.setResponseDepict("累计数据详情");
    urlInfo188.setTransation(true);
    urlInfo188.setRestClass("grandTotal");
    ...
    urlInfo196.setReaquestDepict("重点工序核算");
