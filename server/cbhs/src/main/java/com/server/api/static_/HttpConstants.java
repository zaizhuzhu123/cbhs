...
public class HttpConstants {
    ...
    urlInfo197.setMsgCode(80101);
    urlInfo197.setUrl("/cbhs/zytj/zytjFetch");
    urlInfo197.setOpCode("0");
    urlInfo197.setWorkClass("");
    urlInfo197.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjFetch");
    urlInfo197.setReaquestDepict("主键,部门ID,工程项目ID,总工程量ID,分包公司ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo197.setMsgResponse("com.server.pojo.url.zytj.ResponseZytjFetch");
    urlInfo197.setResponseDepict("资源统计集合,总条数");
    urlInfo197.setTransation(true);
    urlInfo197.setRestClass("zytjFetch");
    ...
    urlInfo198.setMsgCode(80102);
    urlInfo198.setUrl("/cbhs/zytj/zytjUpdate");
    urlInfo198.setOpCode("0");
    urlInfo198.setWorkClass("");
    urlInfo198.setMsgReaquest("com.server.pojo.bean.CbhsZytj");
    urlInfo198.setReaquestDepict("资源统计");
    urlInfo198.setMsgResponse("com.server.pojo.bean.CbhsZytj");
    urlInfo198.setResponseDepict("资源统计");
    urlInfo198.setTransation(true);
    urlInfo198.setRestClass("zytjUpdate");
    ...
    urlInfo199.setMsgCode(80103);
    urlInfo199.setUrl("/cbhs/zytj/zytjDel");
    urlInfo199.setOpCode("0");
    urlInfo199.setWorkClass("");
    urlInfo199.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjDel");
    urlInfo199.setReaquestDepict("资源统计主键集合");
    urlInfo199.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo199.setResponseDepict("响应状态码");
    urlInfo199.setTransation(false);
    urlInfo199.setRestClass("zytjDel");
    ...
    urlInfo200.setMsgCode(80104);
    urlInfo200.setUrl("/cbhs/zytj/zytjAdd");
    urlInfo200.setOpCode("0");
    urlInfo200.setWorkClass("");
    urlInfo200.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjAdd");
    urlInfo200.setReaquestDepict("资源统计,提交方式(0默认提交 1审核提交)");
    urlInfo200.setMsgResponse("com.server.pojo.bean.CbhsZytj");
    urlInfo200.setResponseDepict("资源统计");
    urlInfo200.setTransation(true);
    urlInfo200.setRestClass("zytjAdd");
    ...
    urlInfo201.setMsgCode(80201);
    urlInfo201.setUrl("/cbhs/zytj/zdgxhsFetch");
    urlInfo201.setOpCode("0");
    urlInfo201.setWorkClass("");
    urlInfo201.setMsgReaquest("com.server.pojo.url.zytj.RequestZdgxhsFetch");
    urlInfo201.setReaquestDepict("主键,部门ID,工程项目ID,分包工程量ID,分包公司ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo201.setMsgResponse("com.server.pojo.url.zytj.ResponseZdgxhsFetch");
    urlInfo201.setResponseDepict("重点工序核算集合,总条数");
    urlInfo201.setTransation(true);
    urlInfo201.setRestClass("zdgxhsFetch");
    ...
    urlInfo202.setMsgCode(80202);
    urlInfo202.setUrl("/cbhs/zytj/zdgxhsUpdate");
    urlInfo202.setOpCode("0");
    urlInfo202.setWorkClass("");
    urlInfo202.setMsgReaquest("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo202.setReaquestDepict("重点工序核算");
    urlInfo202.setMsgResponse("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo202.setResponseDepict("重点工序核算");
    urlInfo202.setTransation(true);
    urlInfo202.setRestClass("zdgxhsUpdate");
    ...
    urlInfo203.setMsgCode(80203);
    urlInfo203.setUrl("/cbhs/zytj/zdgxhsDel");
    urlInfo203.setOpCode("0");
    urlInfo203.setWorkClass("");
    urlInfo203.setMsgReaquest("com.server.pojo.url.zytj.RequestZdgxhsDel");
    urlInfo203.setReaquestDepict("重点工序核算主键集合");
    urlInfo203.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo203.setResponseDepict("响应状态码");
    urlInfo203.setTransation(false);
    urlInfo203.setRestClass("zdgxhsDel");
    ...
    urlInfo204.setMsgCode(80204);
    urlInfo204.setUrl("/cbhs/zytj/zdgxhsAdd");
    urlInfo204.setOpCode("0");
    urlInfo204.setWorkClass("");
    urlInfo204.setMsgReaquest("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo204.setReaquestDepict("重点工序核算");
    urlInfo204.setMsgResponse("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo204.setResponseDepict("重点工序核算");
    urlInfo204.setTransation(true);
    urlInfo204.setRestClass("zdgxhsAdd");
