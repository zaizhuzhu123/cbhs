...
public class HttpConstants {
    ...
    urlInfo133.setReaquestDepict("主键,编号,名称,页码,数量,开始编号,工程项目ID,类型(1:大项|2:有单价的项)");
    ...
    urlInfo196.setMsgCode(80101);
    urlInfo196.setUrl("/cbhs/zytj/zytjFetch");
    urlInfo196.setOpCode("0");
    urlInfo196.setWorkClass("");
    urlInfo196.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjFetch");
    urlInfo196.setReaquestDepict("主键,部门ID,工程项目ID,总工程量ID,分包公司ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo196.setMsgResponse("com.server.pojo.url.zytj.ResponseZytjFetch");
    urlInfo196.setResponseDepict("资源统计集合,总条数");
    urlInfo196.setTransation(true);
    urlInfo196.setRestClass("zytjFetch");
    ...
    urlInfo197.setMsgCode(80102);
    urlInfo197.setUrl("/cbhs/zytj/zytjUpdate");
    urlInfo197.setOpCode("0");
    urlInfo197.setWorkClass("");
    urlInfo197.setMsgReaquest("com.server.pojo.bean.CbhsZytj");
    urlInfo197.setReaquestDepict("资源统计");
    urlInfo197.setMsgResponse("com.server.pojo.bean.CbhsZytj");
    urlInfo197.setResponseDepict("资源统计");
    urlInfo197.setTransation(true);
    urlInfo197.setRestClass("zytjUpdate");
    ...
    urlInfo198.setMsgCode(80103);
    urlInfo198.setUrl("/cbhs/zytj/zytjDel");
    urlInfo198.setOpCode("0");
    urlInfo198.setWorkClass("");
    urlInfo198.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjDel");
    urlInfo198.setReaquestDepict("资源统计主键集合");
    urlInfo198.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo198.setResponseDepict("响应状态码");
    urlInfo198.setTransation(false);
    urlInfo198.setRestClass("zytjDel");
    ...
    urlInfo199.setMsgCode(80104);
    urlInfo199.setUrl("/cbhs/zytj/zytjAdd");
    urlInfo199.setOpCode("0");
    urlInfo199.setWorkClass("");
    urlInfo199.setMsgReaquest("com.server.pojo.url.zytj.RequestZytjAdd");
    urlInfo199.setReaquestDepict("资源统计,提交方式(0默认提交 1审核提交)");
    urlInfo199.setMsgResponse("com.server.pojo.bean.CbhsZytj");
    urlInfo199.setResponseDepict("资源统计");
    urlInfo199.setTransation(true);
    urlInfo199.setRestClass("zytjAdd");
    ...
    urlInfo200.setMsgCode(80201);
    urlInfo200.setUrl("/cbhs/zytj/zdgxhsFetch");
    urlInfo200.setOpCode("0");
    urlInfo200.setWorkClass("");
    urlInfo200.setMsgReaquest("com.server.pojo.url.zytj.RequestZdgxhsFetch");
    urlInfo200.setReaquestDepict("主键,部门ID,工程项目ID,分包工程量ID,分包公司ID,开始日期,结束日期,页码,数量,开始ID");
    urlInfo200.setMsgResponse("com.server.pojo.url.zytj.ResponseZdgxhsFetch");
    urlInfo200.setResponseDepict("重点工序核算集合,总条数");
    urlInfo200.setTransation(true);
    urlInfo200.setRestClass("zdgxhsFetch");
    ...
    urlInfo201.setMsgCode(80202);
    urlInfo201.setUrl("/cbhs/zytj/zdgxhsUpdate");
    urlInfo201.setOpCode("0");
    urlInfo201.setWorkClass("");
    urlInfo201.setMsgReaquest("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo201.setReaquestDepict("重点工序核算");
    urlInfo201.setMsgResponse("com.server.pojo.bean.CbhsZdgxhs");
    urlInfo201.setResponseDepict("重点工序核算");
    urlInfo201.setTransation(true);
    urlInfo201.setRestClass("zdgxhsUpdate");
    ...
    urlInfo202.setMsgCode(80203);
    urlInfo202.setUrl("/cbhs/zytj/zdgxhsDel");
    urlInfo202.setOpCode("0");
    urlInfo202.setWorkClass("");
    urlInfo202.setMsgReaquest("com.server.pojo.url.zytj.RequestZdgxhsDel");
    urlInfo202.setReaquestDepict("重点工序核算主键集合");
    urlInfo202.setMsgResponse("com.alibaba.fastjson.JSONObject");
    urlInfo202.setResponseDepict("响应状态码");
    urlInfo202.setTransation(false);
    urlInfo202.setRestClass("zdgxhsDel");
    ...
    urlInfo203.setMsgCode(80204);
    urlInfo203.setUrl("/cbhs/zytj/zdgxhsAdd");
    ...
    urlInfo203.setRestClass("zdgxhsAdd");
