...
public class MenuJavaOut extends AbstractProcess {

	private static String javaModelDir = "\\cbhs\\src\\main\\java\\com\\server\\menu\\";
	...
	public MenuJavaOut(String dir) throws IOException {
	...
	public void finish() throws Exception {
		// 生成BaseC
		javaBw.write("package com.server.menu;");
		javaBw.newLine();
		...
		for (int i = 0; i < protoNames.size(); i++) {
			javaBw.write("	private static String " + protoNames.get(i) + " = \"" + protoNames.get(i) + "\";");
			javaBw.newLine();
		}
		javaBw.write("	private static Map<String, List<MenuObj>> allMenus = new HashMap<String, List<MenuObj>>();");
		javaBw.newLine();
		javaBw.write("	static {");
		javaBw.newLine();
		for (int i = 0; i < protoNames.size(); i++) {
